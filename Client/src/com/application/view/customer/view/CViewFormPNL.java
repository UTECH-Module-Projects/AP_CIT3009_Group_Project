    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource().equals(clear)) {
            ...
            if (showConfirmDialog(btnType + " Customer?") == JOptionPane.YES_OPTION) {
                ...
                boolean result = (Boolean) client.cud(cudType, "Customer", (isSave ? customer : ClientApp.customers.get(custIndex).getIdNum()));
                String idNum = (isSave ? customer.getIdNum() : ClientApp.customers.get(custIndex).getIdNum());
