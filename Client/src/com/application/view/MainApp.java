...
import static com.application.view.ClientApp.*;
...
public class MainApp {
    ...
    private void initializeComponents() {
        frame = new JFrame("Jan's Wholesale POS Application");
    ...
    private void addComponents() {
        if (ClientApp.logEmp.getType().equals("Admin")) {
        ...
        if (ClientApp.logEmp.getType().equals("Admin") || ClientApp.logEmp.getType().equals("Manager")) {
