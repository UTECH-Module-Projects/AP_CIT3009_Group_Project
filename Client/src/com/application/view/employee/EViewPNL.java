...
public class EViewPNL implements ListSelectionListener {
    ...
    private void initializeComponents() {
        ...
        empTBL = new GUIEntityTable(ClientApp.employees.to2DArray(), Employee.headers, true);
     ...
     */
    public void refresh() {
        empTBL.refresh(ClientApp.employees.to2DArray());
        clear();
    }
        ...
        if (!e.getValueIsAdjusting() && rowIndex != -1) {
            try {
                ...
                if (newIndex != empIndex) {
                    empIndex = newIndex;
                    Employee employee = ClientApp.employees.get(empIndex);
